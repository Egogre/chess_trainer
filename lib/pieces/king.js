...
King.prototype.canMoveTo = function (square) {
  return standardKingMovement(this, square)
  || castleMovement(this, square);
};
...
function castleMove (targetSquare) {
  if (targetSquare.xCoordinate === 6) {
    ...
    var newRookSquare = targetSquare.board.findSquare(targetSquare.xCoordinate - 1, this.square.yCoordinate)
