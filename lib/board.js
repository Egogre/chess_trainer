...
Board.prototype.clearPawnDoubleMove = function () {
  var board = this;
  var pawnSquare = board.squares.filter(function (square) {
    return !!square.isOccupied()
      &&square.piece.justMovedTwoLastTurn;
  });
  pawnSquare[0].piece.justMovedTwoLastTurn = false;
};
