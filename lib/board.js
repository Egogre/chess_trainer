...
Board.prototype.drawBoard = function () {
  ...
  board.squares.forEach (function (square) {
    drawSquare.call (board, square)
    if (square.piece) {
      addIcon.call (board, square)
    }
  })
};
...
function drawSquare (square) {
  ...
  this.context.fillStyle = square.pattern;
...
function addIcon (square) {
  ...
  icon.onload = function () {
    if (square.board.game.turn === "white") {
      whitePerspective (square, board.context, icon);
    } else if (square.board.game.turn === "black") {
      blackPerspective (square, board.context, icon);
    }
  };
}
