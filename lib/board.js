...
function loadBlack (board) {
  ...
  for (var i = 8; i < 16; i++) {
    board.squares[i].piece = new BlackPawn (board.squares[i], "black");
  }
};

function loadWhite (board) {
  for (var i = 48; i < 56; i++) {
    board.squares[i].piece = new WhitePawn (board.squares[i], "white");
  }
